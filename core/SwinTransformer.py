...
class SwinTransformer(nn.Module):
    def __init__(self, img_size=[608, 608], patch_size=4, in_chans=3, num_classes=1000,
        ...
        # 192, 384, 768
        self.conv0 = ConvSiLU(96, 64, 1)
        self.conv1 = ConvSiLU(192, 128, 1)
        self.conv2 = ConvSiLU(384, 256, 1)
        self.conv3 = ConvSiLU(768, 512, 1)
...
# def Swin_transformer_Tiny(pretrained=False, input_shape=[608, 608], **kwargs):
...
if __name__ == '__main__':
    model = SwinTransformer([608, 608], depths=[2, 2, 6, 2])
