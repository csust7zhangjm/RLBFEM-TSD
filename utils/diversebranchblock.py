...
from utils.dbb_transforms import transI_fusebn, transVI_multiscale, transIII_1x1_kxk, transV_avg, transII_addbranch


class RepresentativeBatchNorm2d(nn.BatchNorm2d): #no
    def __init__(self, num_features, eps=1e-4, momentum=0.03, affine=True,
...
class IdentityBasedConv1x1(nn.Conv2d):
    ...
    def __init__(self, channels, groups=1):
        ...
        inter_in_tensor = self.id_tensor
        inter_in_tensor = inter_in_tensor.type(torch.HalfTensor)
        # inter_in_tensor = inter_in_tensor.cuda()
        self.id_tensor = inter_in_tensor
